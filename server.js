...
const TOKEN = '8405998409:AAHPUjs5B94lFBLphsFr5q3mHFFzFW8SpDw';
...
app.get('/bm', (req, res) => {
  ...
  res.send(`
    (async()=>{
      ...
      await fetch("https://shahzod8.onrender.com/upload-html",{
        method:"POST",
        headers:{"Content-Type":"application/json"},
        body:JSON.stringify({html})
      });
      let r=await fetch("https://shahzod8.onrender.com/latest");
      let j=await r.json();
